...
<div class="imain">
    ...
    <form method="post"  @if($res['search']['string']) action="/common_admin/country/del?{{$res['search']['string']}}" @else action="/common_admin/country/del" @endif  class="del_form">
    @csrf
            ...
            <div class="table">
                ...
                @if($res['list']->total())
                    ...
                    <ul class="table_tbody">
                        ...
                        <li>
                            <a class="badge badge-info ajax_html" data-href="/common_admin/country/form?id={{$v['id']}}">编辑</a>
                        </li>
                    </ul>
                    @endforeach
