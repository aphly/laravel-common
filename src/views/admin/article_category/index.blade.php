...
<div class="imain">
    <div class="itop ">
        <form method="get" action="/common_admin/article_category/index" class="select_form">
        <div class="search_box ">
            <input type="search" name="name" placeholder="article_category name" value="{{$res['search']['name']}}">
    ...
    <form method="post"  @if($res['search']['string']) action="/common_admin/article_category/del?{{$res['search']['string']}}" @else action="/common_admin/article_category/del" @endif  class="del_form">
    @csrf
