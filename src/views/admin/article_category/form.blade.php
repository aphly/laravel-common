...
<div class="imain">
    <form method="post" @if($res['info']->id) action="/common_admin/article_category/edit?id={{$res['info']->id}}" @else action="/common_admin/article_category/add" @endif class="save_form">
        @csrf
        <div class="">
