<div class="top-bar">
    <h5 class="nav-title">user address</h5>
</div>
<style>
...
<div class="imain">
    <div class="itop ">
        ...
        <div class="">
            <a class="badge badge-primary ajax_get show_all0_btn " data-href="/common_admin/user_address/form">添加</a>
        </div>
    </div>
            ...
            <div class="table">
                ...
                @if($res['list']->total())
                    ...
                    <ul class="table_tbody">
                        ...
                        <li>
                            <a class="badge badge-info ajax_get" data-href="/common_admin/user_address/form?id={{$v['id']}}">编辑</a>
                        </li>
                    </ul>
                    @endforeach
