            ...
            <div class="table">
                ...
                @if($res['list']->count())
                    ...
                    <ul class="table_tbody">
                        ...
                        <li>
                            <a class="badge badge-info ajax_html" data-href="/common_admin/user/{{$v['uuid']}}/edit">编辑</a>
                            <a class="badge badge-info ajax_html" data-href="/common_admin/user/{{$v['uuid']}}/password">修改密码</a>
                            <a class="badge badge-info ajax_html" data-href="/common_admin/user/{{$v['uuid']}}/avatar">头像</a>
                            <a class="badge badge-info ajax_html" data-href="/common_admin/user/{{$v['uuid']}}/credit">积分</a>
                        </li>
                    </ul>
