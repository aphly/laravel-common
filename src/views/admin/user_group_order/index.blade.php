...
<div class="imain">
    ...
    <form method="post"  @if($res['filter']['string']) action="/common_admin/user_group_order/del?{{$res['filter']['string']}}" @else action="/common_admin/user_group_order/del" @endif  class="del_form">
    @csrf
