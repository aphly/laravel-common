...
<div class="top-bar">
    <h5 class="nav-title">credit price</h5>
</div>
<div class="imain">
    <form method="post" @if($res['info']->id) action="/common_admin/credit_price/save?id={{$res['info']->id}}" @else action="/common_admin/credit_price/save" @endif class="save_form">
        @csrf
        <div class="">
            <div class="form-group">
                <label for="">名称</label>
                <select name="credit_key" class="form-control">
            ...
            <div class="form-group">
                <label for="">价格</label>
                <input type="text" name="price" class="form-control " value="{{$res['info']->price??0}}">
                <div class="invalid-feedback"></div>
            </div>
            <div class="form-group">
                <label for="">排序</label>
