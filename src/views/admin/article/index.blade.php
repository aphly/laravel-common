...
<div class="imain">
    <div class="itop ">
        <form method="get" action="/common_admin/article/index" class="select_form">
        ...
        <div class="">
            <a class="badge badge-primary ajax_html show_all0_btn" data-href="/common_admin/article/form">添加</a>
        </div>
    </div>

    <form method="post"  @if($res['search']['string']) action="/common_admin/article/del?{{$res['search']['string']}}" @else action="/common_admin/article/del" @endif  class="del_form">
    @csrf
            ...
            <div class="table">
                ...
                @if($res['list']->total())
                    ...
                    <ul class="table_tbody">
                        ...
                        <li>
                            <a class="badge badge-info ajax_html" data-href="/common_admin/article/form?id={{$v['id']}}">编辑</a>
                        </li>
                    </ul>
                    @endforeach
