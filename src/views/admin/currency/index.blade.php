...
<div class="imain">
    <div class="itop ">
        <form method="get" action="/common_admin/currency/index" class="select_form">
        <div class="search_box ">
            <input type="search" name="name" placeholder="currency name" value="{{$res['search']['name']}}">
    ...
    <form method="post"  @if($res['search']['string']) action="/common_admin/currency/del?{{$res['search']['string']}}" @else action="/common_admin/currency/del" @endif  class="del_form">
    @csrf
